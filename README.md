...
➡️ multi-rnn-lstm-us-stocks.ipynb
...
Ver el Notebook en GitHub:
➡️ multi-rnn-lstm-mx-stocks.ipynb
Ejecutar en Google Colab:
![alt text](https://colab.research.google.com/assets/colab-badge.svg)
...
![alt text](Screenshot_20250725_004740.png)
Panel de Control de Oportunidades (Top 5)
![alt text](Screenshot_20250725_004834.png)
🇲🇽 Mercado Mexicano (BMV)
Tabla de Pronósticos de Rendimiento para la BMV
![alt text](Screenshot_20250725_004905.png)
Panel de Control de Oportunidades (Top 3)
![alt text](Screenshot_20250725_005018.png)
💡 Próximos Pasos
